...
public class BaseDaoImpl implements BaseDao {
	...
	public List findResultForPager(String hql, int start, int num) {
		...
		ServiceRegistry resgistry = new ServiceRegistryBuilder().applySettings(
	...
	// List
	// results=this.getHibernateTemplate().findByCriteria(detachedCriteria);
	// if(results!=null&&results.size()>0)
	// return results.size();
	// else
	// return 0;
	...
	// }
	//
	// public List findResultForPager(DetachedCriteria detachedCriteria,Pager
	// pager){
	//
	// return this.getHibernateTemplate().findByCriteria(detachedCriteria,
	// pager.getCurrentPage()*pager.getNumForEachPage(),
	// pager.getNumForEachPage());
	//
	// }
	//
